 ...
 */
public interface FunctionAgentTool<Req> extends AgentTool {
     ...
     */
    ToolResponse call(Req input);

    @Override
    default ToolResponse call(Map<String, Object> input) {
        // Default implementation casts the map input to the generic type
        @SuppressWarnings("unchecked")
        Req reqInput = (Req) input;
        return call(reqInput);
    }
